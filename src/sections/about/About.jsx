  ...
  return (
    <section className="flex flex-col justify-center items-center gap-[120px] mt-12 lg:mt-20 w-11/12 xl:w-4/5">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="">
          <h1 className="text-brand-primary-400 font-recoleta-500 leading-9 sm:leading-[54px] font-normal text-2xl lg:text-[40px] sm:w-2/3 mb-4">
            Our love for building the unexpected{" "}
            <span className="text-brand-primary-100">
              is contagious!
              <span className="relative h-2 sm:flex justify-center lg:justify-end left-1/3 md:w-3/5 hidden sm:">
                <Image priority fill src={CurvedLine} alt="" />
              </span>
            </span>
          </h1>
          <p className="font-dmsans-400 font-normal leading-5 sm:leading-7 tracking-[-0.015em] sm:w-4/5 text-xs lg:text-xl">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="">
          <h1 className="text-brand-primary-400 font-recoleta-500 font-normal leading-9 sm:leading-[54px] text-2xl lg:text-[40px] md:w-3/5 mb-4">
            The art of problem-solving is our forte
          </h1>
          <p className="font-dmsans-400 font-normal leading-5 sm:leading-7 tracking-[-0.015em] w-4/5 text-xs lg:text-xl">
